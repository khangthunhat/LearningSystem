        ...
        <div className="grid md:grid-cols-2 items-center gap-4 max-md:gap-8 max-w-6xl max-md:max-w-lg w-full p-4 m-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md bg-white dark:bg-gray-800">
          <div className="md:max-w-md w-full px-4 py-4">
            <form onSubmit={handleSubmit}>
              <div className="mb-12">
                <h3 className="text-gray-800 dark:text-white text-3xl font-extrabold">Đăng nhập</h3>
                <p className="text-sm mt-4 text-gray-800 dark:text-gray-300">Bạn không có tài khoản? <a onClick={handleRegister} className="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Đăng ký tài khoản</a></p>
              </div>
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 mt-6">
                <div className="flex items-center">
                  ...
                  <label htmlFor="remember-me" className="ml-3 block text-sm text-gray-800 dark:text-gray-200">
                    Ghi nhớ mật khẩu
                  </label>
                </div>
                <div>
