      ...
      <section className="bg-white dark:bg-gray-900">
        ...
        <div className="flex flex-col-reverse lg:grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-7 xl:gap-15 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-5 text-3xl font-bold tracking-tight leading-none md:text-3xl xl:text-3xl dark:text-white">
            Học hỏi và Chia sẻ Tri thức 
            </h1>
            <h1 className="max-w-2xl mb-4 text-3xl font-extrabold tracking-tight leading-none md:text-6xl xl:text-6xl dark:text-white">
            Mọi Nơi, Mọi Lúc
            </h1>
            <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
              <span className="font-bold text-2xl text-black dark:text-white">GoDoc</span> - Nền tảng học tập và chia sẻ tài liệu hàng đầu, giúp bạn tiếp cận kho tàng khóa học và tài liệu phong phú từ mọi lĩnh vực. Học dễ dàng, chia sẻ kiến thức không giới hạn, cùng cộng đồng xây dựng tương lai tri thức!
            </p>
            <a
              href="#"
